# Deploying PennAI in javascript with Amazon ECS and AWS CloudFormation

This reference architecture provides a set of JSON templates for deploying to [Amazon EC2 Container Service (Amazon ECS)](http://docs.aws.amazon.com/AmazonECS/latest/developerguide/Welcome.html) with [AWS CloudFormation](https://aws.amazon.com/cloudformation/).
